...
from data_pipeline_fusion import build_cv_dataloaders
...
from mamba_fusion_model import MambaFusionModel
...
def main() -> None:
    ...
    logger = configure_logging(output_dir / "train_fusion_mamba.log")

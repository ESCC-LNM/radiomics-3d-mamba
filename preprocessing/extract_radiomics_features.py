...
def _build_extractor(cfg: Mapping[str, Any]):
    try:
        ...
        raise ImportError(
            "PyRadiomics is required for extract_radiomics_features.py. Install it with the project requirements."
        ) from exc
...
def main() -> None:
    ...
    logger = configure_logging(output_root / "extract_radiomics_features.log")
